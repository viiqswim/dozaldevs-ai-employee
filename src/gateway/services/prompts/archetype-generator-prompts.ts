...
3. Submit output confirming the delivery was completed.
...
Note: delivery_steps MUST write to ${SUMMARY_PATH} at the end (via submit-output) — the harness reads this file.`;
