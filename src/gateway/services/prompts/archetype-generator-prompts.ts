...
For delivery_steps: MUST be a non-empty numbered list whenever deliverable_type is set. Set to null ONLY when deliverable_type is also null (pure utility employees that take no delivery action). For delivery_instructions: set to null (this field is deprecated and ignored at runtime).
`;
