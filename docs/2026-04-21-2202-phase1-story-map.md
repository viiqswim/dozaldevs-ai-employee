...
- [x] `src/worker-tools/hostfully/get-property.js` exists and follows the same pattern as `src/worker-tools/slack/post-message.ts`
...
- [x] `src/worker-tools/hostfully/get-reservations.js` exists
...
- [x] `src/worker-tools/hostfully/get-messages.js` exists
...
- [ ] `src/worker-tools/hostfully/send-message.js` exists
...
- [ ] `src/worker-tools/hostfully/get-reviews.js` exists
...
| **Validates**     | `[platform-eng]`, `[vlre-ops]`                                                                                                                                                                                                                                                                                                                           |
| **Dependencies**  | GM-04                                                                                                                                                                                                                                                                                                                                                    |
| **Porting notes** | Standalone MVP has rich Block Kit cards in `skills/slack-bot/handlers/`. The platform already has Slack Block Kit approval cards for the daily summarizer (`src/worker-tools/slack/post-message.ts` with `buildApprovalBlocks`). Extend the existing tool to support a guest messaging card layout, or create a new `post-guest-approval.js` shell tool. |
...
- [ ] New shell tool: `src/worker-tools/locks/diagnose-access.js --property-id "<id>" --reservation-id "<id>"`
...
- [ ] `src/worker-tools/hostfully/get-calendar.js` exists
