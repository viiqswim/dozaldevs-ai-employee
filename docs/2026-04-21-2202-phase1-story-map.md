...
All worker shell tools are authored in **TypeScript** (`src/worker-tools/**/*.ts`) and compiled to JavaScript before being copied into the Docker image:

- **Source**: `src/worker-tools/<service>/<tool>.ts` — TypeScript, edit this
- **Compiled**: `dist/worker-tools/<service>/<tool>.js` — generated, do not edit
- **Docker path**: `/tools/<service>/<tool>.js` — runtime path inside the worker container

Story acceptance criteria reference the `.ts` source file. The `node /tools/...` usage examples reference the `.js` compiled path inside Docker — both are correct.
...
- [x] Usage: `node /tools/hostfully/get-property.js --property-id "<id>"` outputs JSON to stdout
...
- [x] Usage: `node /tools/hostfully/get-reservations.js --property-id "<id>" [--status confirmed] [--from "2026-05-01"] [--to "2026-05-31"]`
...
- [x] Usage: `node /tools/hostfully/get-messages.js --property-id "<id>" [--unresponded-only] [--limit 30]`
...
- [ ] Content covers all five points in Notes: source access, patch permission, smoke test, mandatory reporting, platform code off-limits
...
- [ ] Usage: `node /tools/platform/report-issue.js --task-id "<id>" --tool-name "get-messages" --description "..." [--patch-diff "..."]`
...
- [ ] Usage: `node /tools/hostfully/send-message.js --reservation-id "<id>" --message "<text>"`
...
- [ ] Usage: `node /tools/hostfully/get-reviews.js [--property-id "<id>"] [--since "2026-05-01"] [--unresponded-only]`
...
- [ ] Shell tool or mechanism for the OpenCode employee to query KB content: `node /tools/kb/search.js --property-id "<id>" --query "wifi password"`
...
- [ ] Usage: `node /tools/hostfully/get-calendar.js --property-id "<id>" [--from "2026-05-01"] [--to "2026-06-30"]`
