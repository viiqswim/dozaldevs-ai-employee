...
- **Release 1.1 + 1.2**: These releases can overlap. Safety net stories (GM-07 through GM-14) are independent of webhook and smart lock stories (GM-22, GM-15). A two-engineer team can split across them.
...
| Guest Messaging Assistant         | GM        | 22 stories | [Section 1.2](./2026-04-21-1813-product-roadmap.md#12-guest-messaging-assistant)   |
...
**Total: 52 stories across 6 epics and 5 releases + cleanup.**
