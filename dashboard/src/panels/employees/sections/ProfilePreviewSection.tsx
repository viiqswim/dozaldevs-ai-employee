    ...
    >
      ...
      {!loading && !error && data && (
        <div className="space-y-3">
          ...
          >
            <AutoGeneratedBlock
              summary="Prevents the employee from following instructions embedded in external data and protects system internals."
              content={data.autoInjectedSections.securityPreamble}
            />
          </CollapsibleSection>
          ...
          >
            <AutoGeneratedBlock
              summary="Tells this employee how to report results when finished — including output format, error handling, and how to discover available tools."
              content={data.autoInjectedSections.outputContract}
            />
          </CollapsibleSection>
