...
4. **Reglas de Basura:**
	...
	- Si el día analizado es el día siguiente a la recolección en esa propiedad, añadir la tarea: *"Confirmar recolección y guardar botes"*. Los recordatorios de sacar los botes y meterlos deben agregarse aunque no tenga agendadas limpiezas en ese día.
<empty-block/>