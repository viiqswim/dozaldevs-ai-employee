...
- [x] F3. **Real Manual QA** — `unspecified-high` (+ `e2e-testing` skill)
...
- [x] 12. **Notify completion** — Send Telegram: `tsx scripts/telegram-notify.ts "Slack Employee Trigger plan complete, all tasks done, come back to review."`
